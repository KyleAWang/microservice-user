 ...
 *         &lt;element ref="{http://ofbiz.apache.org/service/}eeval-UserLogin" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ColCollection {
    ...
    @XmlElement(name = "eeval-UserLogin")
    protected List<EevalUserLogin> eevalUserLogin;
    ...
    /**
     * Gets the value of the eevalUserLogin property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the eevalUserLogin property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEevalUserLogin().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EevalUserLogin> getEevalUserLogin() {
        if (eevalUserLogin == null) {
            eevalUserLogin = new ArrayList<EevalUserLogin>();
        }
        return this.eevalUserLogin;
    }
